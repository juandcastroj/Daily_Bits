...
import { questionCSS } from '../data/Questionario';
...
export default class QuestionCSS extends Component {
    ...
    handleSubmit = (e) => {
        ...
        if (this.state.numberQuestion < questionCSS.length) {
            ...
            alert(cookies.get('nombre')+ " , obtuviste " + this.state.score +" respuestas correctas de 6")
        ...
        return (
            <DivForm>
                <FormStyle onSubmit={this.handleSubmit}>
                    ...
                    <ProgressBar  variant="success" max="5" animated now={this.state.numberQuestion} />
                    {/* <h2 style={{ textAlign: "center" }}>{this.state.score}/{questionCSS.length} </h2> */}
                    ...
                    <ButtonStyle  type="submit" onClick={() => { this.setState({ numberQuestion: this.state.numberQuestion + 1 }) }}>
                        COMPROBAR 
                    </ButtonStyle>
