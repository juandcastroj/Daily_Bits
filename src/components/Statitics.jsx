...
const Statitics = () => {
  ...
  return (
    <div  style={{ backgroundColor: "black" }}  >
      <main>
      <br></br>
        <Title>Estadísticas  de {cookies.get('nombre')} </Title>
        ...
        <br></br>
            <><br></br>
              <StatiticsContainer>
                ...
                <CountTimes id="count-times">hours</CountTimes>
              ...
              <StatiticsContainer>
                ...
                <CountResponseSuccess id="count-response-success">
                  successResponses
                </CountResponseSuccess>
              </StatiticsContainer>
              <br></br>
              ...
              <StatiticsContainer>
                ...
                <CountResponseFailed id="count-response-failed">
                  failedResponses
                </CountResponseFailed>
